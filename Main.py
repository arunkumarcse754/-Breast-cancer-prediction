...
def result():
    ...
    test_image = image.load_img('Output/Out/Test.jpg', target_size=(50, 50))
...
def main_account_screen():
    ...
    main_screen.title("Breast Cancer Disease Prediction ")

    Label(text="Breast Cancer  Disease Prediction", width="300", height="5", bg='cyan', font=("Calibri", 16)).pack()
